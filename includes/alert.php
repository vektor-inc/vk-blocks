...
add_action(
	'init', function() {
		// Register CSS
		wp_register_style( 'vk-block-alert-css', VK_BLOCKS_ASSET_URL . 'assets/css/alert.css', [], VK_BLOCKS_VERSION );
		// Register JS
		wp_register_script( 'vk-block-alert-js', VK_BLOCKS_ASSET_URL . 'assets/js/alert.js', [ 'wp-element', 'wp-blocks','wp-i18n' ], VK_BLOCKS_VERSION, true );
		// Register block.
