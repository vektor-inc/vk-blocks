	...
	class VK_CSS_Optimize {
		...
		public static function customize_register( $wp_customize ) {
			...
			$wp_customize->add_control(
				'vk_css_optimize_options[preload_handle_exclude]',
				array(
					'label'       => __( 'Exclude class of Preload CSS', 'vk-blocks' ),
					'section'     => 'css_optimize',
					'settings'    => 'vk_css_optimize_options[preload_handle_exclude]',
					'type'        => 'textarea',
					'description' => __( 'If you choose "Active Preload CSS" that css load timing was changed.If you have any do not want to preload css file that please fill in handle(id) name. Ex) pluginname_a-style,pluginname_b-css', 'vk-blocks' ),
				)
			);
